...
const COLUMN_ALIASES = {
  ...
  commission: ['вознаграждениевайлдберризвв', 'вознаграждениевайлдберриз', 'вознаграждениесвсехпродаж'],
  toTransfer: [
  ...
  acceptance: ['платнаяприемка', 'стоимостьплатнойприемки', 'операциипоприемке', 'операцииприприемке'],
  ...
  returns: ['колвовозвратов', 'количествовозвратов', 'колвовозврата'],
